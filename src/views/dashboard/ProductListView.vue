...
<template>
  ...
  <product-modal :temp-product="tempProduct" ref="ProductModalDOM" @update-product="updateProduct" />
          ...
          <tr v-for="product in products" :key="product.id">
            ...
            <td>
              <div class="input-group flex-nowrap">
                <button type="button" class="btn btn-sm btn-outline-primary" @click="editProduct(product)">
                  編輯
                </button>
                <button type="button" class="btn btn-sm btn-outline-danger" @click="deleteConfirm(product)">
                  刪除
                </button>
              </div>
            </td>
